...
_OOD_KW = [
    ...
    'อัตราแลกเปลี่ยน', 'ดอกเบี้ย', 'เงินดอลลาร์', 'forex',
    # สินค้าโภคภัณฑ์ / ราคาตลาด
    'ทองคำ', 'ทอง', 'น้ำมัน', 'ราคาน้ำมัน', 'ราคาทอง', 'ราคาหุ้น',
    'ราคา apple', 'ราคา iphone', 'ราคา samsung',
    # แบรนด์ tech / สินค้า IT
    'iphone', 'ipad', 'macbook', 'samsung galaxy', 'playstation', 'xbox',
    # กีฬา
    'ฟุตบอล', 'บาสเกตบอล', 'นักกีฬา', 'แมนยู', 'บอลโลก',
    'เรอัล มาดริด', 'บาร์เซโลนา', 'พรีเมียร์ลีก', 'fifa',
    # การเมือง
    'การเมือง', 'นายกรัฐมนตรี', 'พรรคการเมือง', 'เลือกตั้ง', 'รัฐบาล',
    'สส', 'สว', 'รัฐสภา', 'กระทรวง',
    # บันเทิง
    'ละคร', 'ซีรีส์', 'ดารา', 'เพลง', 'หนัง', 'คอนเสิร์ต',
    'เน็ตฟลิกซ์', 'netflix', 'youtube', 'tiktok',
    # สุขภาพ / ยา (ไม่เกี่ยวกับ YRU)
    'ราคายา', 'โรงพยาบาล', 'คลินิก', 'หมอ', 'ยารักษา',
    # ทั่วไปที่ชัดเจนว่านอก domain
    'ราคาบ้าน', 'ราคารถ', 'อาหาร', 'ร้านอาหาร', 'เมนู', 'สูตรอาหาร',
    'ท่องเที่ยว', 'โรงแรม', 'ตั๋วเครื่องบิน', 'วีซ่า',
